...
<html lang="en">
    ...
    <body>
        ...
        <table class="table mb-0">
            <tbody>
                <tr>
                    <td class="border-0 pl-0" colspan="2" width="100%">
                        <hr class="red-line" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="border-0 pl-0 text-right">
                        @if($invoice->logo)
                            <img src="{{ $invoice->getLogo() }}" alt="logo" height="50px">
                        @endif
                    </td>
                </tr>
                <tr><td class="header-separator" colspan="2"></td></tr>
                <tr>
                    <td class="border-0 pl-0 seller-block" width="70%">
                    ...
                    <td class="border-0 pl-0">
                        <p class="text-uppercase border-bottom">{{ __('invoices::invoice.date') }}: <strong>{{ $invoice->getDate() }}</strong></p>
                        <p class="text-uppercase border-bottom">{{ __('invoices::invoice.serial') }} <strong>{{ $invoice->getSerialNumber() }}</strong></p>
                        @if($invoice->status)
        ...
        <table class="table mb-0">
            <thead>
                <tr>
                    <th class="border-bottom pl-0" width="40%">
                        {{ __('invoices::invoice.customer') }}
                    </th>
                    <th class="border-0" width="20%"></th>
                    <th class="border-bottom pl-0">
                        {{ __('invoices::invoice.contact.person') }}
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="px-0 seller-block">
        ...
        <p class="line-ht-30 red-line text-center" width="100%">
            {{config('app.inv_web')}}
        </p>
